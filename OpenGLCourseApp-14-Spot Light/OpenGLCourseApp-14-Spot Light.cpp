...
int main()
{
	...
	const char* cubeVertexSourcePath = "C:\\Users\\bgyas\\source\\repos\\OpenGLCourseApp\\OpenGLCourseApp-14-Spot Light\\cubeVertexShaderSource.txt";
	const char* cubeFragmentSourcePath = "C:\\Users\\bgyas\\source\\repos\\OpenGLCourseApp\\OpenGLCourseApp-14-Spot Light\\cubeFragmentShaderSource.txt";

	const char* lightVertexSourcePath = "C:\\Users\\bgyas\\source\\repos\\OpenGLCourseApp\\OpenGLCourseApp-14-Spot Light\\lightVertexShaderSource.txt";
	const char* lightFragmentSourcePath = "C:\\Users\\bgyas\\source\\repos\\OpenGLCourseApp\\OpenGLCourseApp-14-Spot Light\\lightFragmentShaderSource.txt";
	...
	while (!glfwWindowShouldClose(mainWindow)) {
		...
		CubeShader.SetFloat3("light.ambient", 0.2, 0.2, 0.2); // note that all light colors are set at full intensity
		CubeShader.SetFloat3("light.diffuse", lightColor.x, lightColor.y, lightColor.z);
		CubeShader.SetFloat3("light.specular", lightColor.x, lightColor.y, lightColor.z);
		CubeShader.SetFloat("light.cutOff", glm::cos((glm::radians(12.5f))));
		CubeShader.SetFloat("light.cutOffOuter", glm::cos((glm::radians(17.5f))));
		CubeShader.SetFloat3("light.direction", 0.0f, 0.0f, -1.0f);
		//set texture units for samplers
		std::cout<<"camera front x: "<< camera.GetFront().x << " y: " << camera.GetFront().y << " z: " << camera.GetFront().z << std::endl;
		CubeShader.SetInt("diffuseT", 0);
		CubeShader.SetInt("specularT", 1);

		//material struct proprties
		CubeShader.SetFloat("material.shininess", 64.0f);

		//these values for 50 meters attenuation
		CubeShader.SetFloat("material.kConstant", 1.0f);
		CubeShader.SetFloat("material.kLinear", 0.09f);
		CubeShader.SetFloat("material.kQuadratic", 0.032f);
