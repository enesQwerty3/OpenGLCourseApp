...
void CreateTriangle(GLuint& VAO, GLuint& texture);
...
int main()
{
	...
	GLuint VAO, texture;
	const char* vertexSourcePath = "C:\\Users\\bgyas\\source\\repos\\OpenGLCourseApp\\OpenGLCourseApp-6-Textures\\vertexShaderSource.txt";
	const char* fragmentSourcePath = "C:\\Users\\bgyas\\source\\repos\\OpenGLCourseApp\\OpenGLCourseApp-6-Textures\\fragmentShaderSource.txt";
	//create 2D triangle
	
	//create shader program
	Shader ShaderProgram = Shader(vertexSourcePath, fragmentSourcePath);
	CreateTriangle(VAO, texture);
...
void CreateTriangle(GLuint& VAO, GLuint& texture) {
	...
	//deallocate image from memory after bound to texture variable
